  ...
  return (
    <section className="relative overflow-hidden rounded-3xl border border-white/10 bg-brand-surface">
      ...
      <div className="relative px-6 py-20 md:px-12">
        ...
        <p className="mt-5 max-w-xl text-brand-muted">Book premium cuts, fades, and grooming treatments with our experienced team.</p>
        <div className="mt-8 flex gap-4">
          <Link href="/book" className="rounded-full bg-brand-accent px-6 py-3 font-semibold text-black">Book Now</Link>
          <Link href="/services" className="rounded-full border border-white/20 px-6 py-3">View Services</Link>
        </div>
      </div>
    </section>
  );
